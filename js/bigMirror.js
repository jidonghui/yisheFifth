...
var singleton = (function(){
	...
	BigMirror.prototype.createAllDom = function(){
		...
		let cssStr = "position:absolute;cursor:crosshair;";
		this.mirrorDom.style.cssText = cssStr;
		
		//2、放大效果
		//2.1放大效果的可视区域
		this.showBoxDom= $create("div");
		cssStr = "position:absolute;overflow:hidden;z-index:999;margin-left:10px;";
	...
	BigMirror.prototype.initEvent = function(){
		...
		//给容器里绑定onmousemove事件
		addEvent(this.boxDom,"mousemove",boxDomonmousemove,false);
